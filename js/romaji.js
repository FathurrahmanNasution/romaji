...
const ROMAJI = {
  ...
  initWorker() {
    ...
    // Embed the worker code as a Blob to completely bypass Vercel path, caching, and CORS issues!
    const workerCode = `
      importScripts(
    ...
    this.worker.onerror = (err) => {
      console.error("Blob Worker creation failed:", err);
    };
